	...
	$scope.openDownloadLink = function () {
		...
		if (typeof (process.platform) !== "undefined") {
			switch (process.platform) {
				case 'win32':
					appPlatform = "trustnote-win64.exe";
					break;
				case 'linux':
					appPlatform = "trustnote-linux64.zip";
					break;
				case 'darwin':
					appPlatform = 'trustnote-osx64.dmg';
					break;
			}
		} else {
			if (window.cordova.platformId === "android")
				appPlatform = "trustnote.apk"
		}
		link = 'https://trustnote.org/trustnote/' + appPlatform;
