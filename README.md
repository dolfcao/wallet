...
```sh
git clone https://github.com/trustnote/trustnote.git
cd trustnote
```
...
* [GitHub Issues](https://github.com/trustnote/trustnote/issues)
  * Open an issue if you are having problems with this project
* [Email Support](mailto:trustnote@trustnote.org)
