...
var crowdin_identifier = 'trustnote'
    ...
    res.on('data', function(chunk) {
      ...
      if (resxml.indexOf('status="skipped"') >= 0) {
        console.log('Translation build was skipped due to either:\n' +
                    ...
                    'Log in to Trustnote\'s Crowdin Settings and click the "Build Project" button to assure it is built recently, and then run this ' +
